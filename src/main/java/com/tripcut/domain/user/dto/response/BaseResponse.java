...
import com.tripcut.domain.user.exception.status.SuccessStatus;
...
public class BaseResponse<T> {
    ...
    public static <T> BaseResponse<T> onSuccess(T result) {
        return new BaseResponse<>(true, SuccessStatus.SUCCESS.getCode() , SuccessStatus.SUCCESS.getMessage(), result);
    }
